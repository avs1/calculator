...
class CalculatorTests
{
	public void Sum_2Plus5_7Returned()
	{
		...
		// act
		var res = calc.CalculateExpression("2+5");

		// assert
		Assert.AreEqual(7, res);
	}
	public void subtract_7Minus5_2Returned()
	{
		// arrange
		var calc = new Calculator();

		// act
		var res = calc.CalculateExpression("7-5");

		// assert
		Assert.AreEqual(2, res);
	}
	public void mult_7mult5_35Returned()
	{
		// arrange
		var calc = new Calculator();
	...
	public void div_10div5_2Returned()
	{
		// arrange
		var calc = new Calculator();

		// act
		var res = calc.CalculateExpression("10/5");
...
namespace testcalc
{
	class MainClass
	{
		public static void Main (string[] args)
		{
			...
			test.div_10div5_2Returned();
			test.mult_7mult5_35Returned();
			test.subtract_7Minus5_2Returned();
			test.Sum_2Plus5_7Returned();
